"""
Nigeria NDWI and NDMI Extraction Script - Exports to YOUR Rasters Folder
...
# Configuration - USING YOUR FOLDER
YEARS = [2015, 2018, 2021, 2023, 2024]
MONTHS = range(7, 13)  # July to December
GOOGLE_DRIVE_FOLDER = 'Rasters'  # YOUR SPECIFIED FOLDER
...
def main():
    ...
    print("\n" + "="*60)
    print("Nigeria NDWI/NDMI Export to YOUR Google Drive Folder")
    print(f"Google Drive folder: {GOOGLE_DRIVE_FOLDER}")
    print(f"Your folder link: https://drive.google.com/drive/folders/1pjkF_04oAR0kLVXmCxjjX1ed3FElk7rr")
    print(f"Years: {YEARS}")
    ...
    print(f"Files will be saved to YOUR Google Drive folder: {GOOGLE_DRIVE_FOLDER}")
    print("="*60)
    ...
    if monitor.lower() == 'y':
        ...
        print(f"Files will appear in YOUR Google Drive folder: {GOOGLE_DRIVE_FOLDER}")
