#!/bin/bash
# Deploy fix for double .html extension in visualization filenames

echo "========================================"
echo "Deploying Visualization Filename Fix"
echo "========================================"
echo ""
...
if [ $RESULT_1 -eq 0 ] && [ $RESULT_2 -eq 0 ]; then
    ...
    echo ""
    echo "Fix applied:"
    echo "  • Fixed double .html extension issue in visualization filenames"
    echo "  • Filenames no longer have pattern: file.html_timestamp_hash.html"
    echo "  • Now they have correct pattern: file_timestamp_hash.html"
    echo ""
    echo "Affected visualizations:"
    echo "  • Vulnerability maps (composite method)"
    echo "  • Composite score maps"
    echo "  • Decision tree visualizations"
    echo ""
