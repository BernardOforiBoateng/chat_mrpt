...
echo "=========================================="
echo "DEPLOYING FILE PATH LOGGING"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "✅ FILE PATH LOGGING DEPLOYED\!"
echo "=========================================="
echo ""
echo "Now upload a file and check the logs to see the actual paths being used"
