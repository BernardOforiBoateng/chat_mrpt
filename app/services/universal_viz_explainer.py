...
class UniversalVisualizationExplainer:
    ...
    def explain_visualization(self, viz_path: str, viz_type: str = None, session_id: str = None) -> str:
        ...
        """
        # TEMPORARY: Skip image conversion and LLM analysis to improve performance
        # Return fallback explanation immediately
        logger.info(f"Using fallback explanation for performance (skipping image conversion): {viz_type}")
    ...
    def _fallback_explanation(self, viz_type: str) -> str:
        ...
        if viz_type == 'vulnerability_map':
            return f"""📊 **Vulnerability Map Generated**

This map displays ward-level malaria vulnerability using color-coded risk categories.

**Key features:**
- Red/dark areas indicate highest vulnerability
- Yellow/medium shades show moderate risk
- Green/light areas represent lower vulnerability
- Click on wards for detailed statistics"""
        
        elif viz_type == 'box_plot':
            return f"""📊 **Box Plot Ranking Generated**

This chart shows the distribution of risk scores across wards with statistical quartiles.

**Key features:**
- Box shows 25th-75th percentile range
- Line indicates median score
- Whiskers extend to min/max values
- Individual ward rankings displayed"""
        
        elif viz_type == 'pca_map':
            return f"""📊 **PCA Vulnerability Map Generated**

This map shows risk patterns identified through Principal Component Analysis.

**Key features:**
- Colors represent PCA-derived risk scores
- Captures complex multi-variable relationships
- Darker shades indicate higher risk
- Based on statistical dimension reduction"""
        
        elif viz_type == 'urban_extent_map':
            return f"""📊 **Urban Extent Map Generated**

This map overlays urbanization levels with malaria risk patterns.

**Key features:**
- Shows urban vs rural distinctions
- Highlights risk in different settlement types
- Greyed areas below urban threshold
- Useful for targeted interventions"""
        
        elif viz_type == 'composite_score_maps':
            return f"""📊 **Composite Score Maps Generated**

Multiple maps showing individual risk factor contributions.

**Key features:**
- Each map represents one risk model
- Compare patterns across different factors
- Identify dominant risk drivers by area
- Paginated for easier viewing"""
        
        elif viz_type == 'itn_map':
            return f"""📊 **ITN Distribution Map Generated**

This map shows the allocation of insecticide-treated nets across wards.

**Key features:**
- Color intensity shows net allocation density
- Prioritizes highest-risk areas
- Hover for ward-specific allocations
- Guides distribution logistics"""
        
        elif viz_type == 'settlement_map':
            return f"""📊 **Settlement Map Generated**

This map displays building classifications and settlement patterns.

**Key features:**
- Different colors for building types
- Zoom in for detailed settlement view
- Useful for micro-planning
- Shows population distribution"""
        
        # Generic fallback
        return f"""📊 **{viz_name} Generated**

This visualization shows malaria risk analysis results for decision-making.
