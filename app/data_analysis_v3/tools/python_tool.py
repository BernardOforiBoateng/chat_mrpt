...
def analyze_data(
    ...
    This is the main tool for data analysis, following AgenticDataAnalysis pattern.
    It executes Python code with persistent state and automatic data loading.
    
    Args:
        thought: Internal reasoning about the analysis (hidden from user)
        python_code: Python code to execute for analysis
        
    Returns:
        String output from code execution
    """
    # Get session ID from graph state if available
    if graph_state:
    ...
    # Format output but preserve numbered lists for health officials
