...
export class SidebarManager {
     ...
     */
    init() {
        this.sidebar = DOMHelpers.getElementById('settings-sidebar');
        this.sidebarToggle = DOMHelpers.getElementById('sidebar-toggle');
        this.closeSidebarBtn = DOMHelpers.getElementById('close-settings-sidebar');
     ...
     */
    setupEventListeners() {
        // Note: sidebar-toggle is now handled by nav-settings in vertical nav
        // Keep this listener for backward compatibility
