"""Synchronous analysis HTTP handlers."""
...
def run_analysis(session_id: str):
    """Run the malaria risk analysis for a session."""
    ...
    high, medium, low = extract_risk_wards(data_handler, result)
...
def extract_risk_wards(data_handler, result):
    high, medium, low = [], [], []
...
__all__ = ['run_analysis', 'explain_variable_selection', 'extract_risk_wards']
