...
class InstanceSync:
    ...
    def __init__(self):
        """Initialize with known instance IPs."""
        # Staging instance IPs (internal)
        self.staging_instances = [
            '172.31.46.84',  # Instance 1 internal IP
            '172.31.24.195'  # Instance 2 internal IP
        ]
        
        # Production instance IPs (if needed)
        self.production_instances = [
            '172.31.44.52',
            '172.31.43.200'
        ]
        ...
        self.instances = self.staging_instances if 'staging' in self.environment else self.production_instances
