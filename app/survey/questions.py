...
Structure follows Appendix 5 exactly:
- Section 1: General Knowledge of Malaria (5 topics)
- Section 2: TPR Analysis (5 topics)
- Section 3: Visualization (4 topics)
Total: ~98 questions
"""
...
class SurveyQuestions:
    ...
    SECTIONS = {
        'general_knowledge': {
            ...
            'topics': {
                ...
                # Topic 2: Within Ward Heterogeneity
                'ward_heterogeneity': {
                ...
                # Topic 5: High-Risk Areas Characteristics
                'high_risk_areas': {
        ...
        'tpr_analysis': {
            ...
            'topics': {
                ...
                # Topic 2: TPR and Environmental Risk
                'tpr_environmental': {
    ...
    def get_questions_for_trigger(cls, trigger_type: str, context: Dict[str, Any] = None) -> List[Dict[str, Any]]:
        """Get questions based on trigger type - returns all questions for cognitive assessment."""
        # For cognitive assessment, return all questions
        return cls.get_all_questions()
