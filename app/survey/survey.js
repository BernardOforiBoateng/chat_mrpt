...
class SurveyHandler {
    ...
    async startSurvey() {
        ...
        try {
            ...
            console.log('[DEBUG] Questions loaded:', this.questions ? this.questions.length : 0);
            console.log('[DEBUG] First few questions:', this.questions ? this.questions.slice(0, 3) : 'No questions');
                            ...
                            <div class="scale-slider-container" style="margin: 0 auto; max-width: 600px;">
                                <div class="scale-labels" style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                                    ${question.labels ? question.labels.map((label, i) =>
                                        ...
                                        <span style="font-size: 0.875rem; color: #6b7280;">${question.min}</span>
                                        <span style="font-size: 0.875rem; color: #6b7280;">${Math.floor((question.max + question.min) / 2)}</span>
                                        <span style="font-size: 0.875rem; color: #6b7280;">${question.max}</span>
                                    `}
                                </div>
                                <input type="range"
                                       id="response_${question.id}"
                                ...
                                <div style="text-align: center; margin-top: 1rem;">
                                    <span style="font-size: 1.5rem; font-weight: bold; color: #2563eb;"
                                          id="scale_value_${question.id}">${Math.floor((question.max + question.min) / 2)}</span>
                                </div>
                            </div>
                        </div>
                    `;
