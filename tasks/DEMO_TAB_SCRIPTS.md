...
> 1. **Which state?** → Adamawa (auto-detected from the data)
> 2. **Which facility level?** → Primary facilities (9,912 facilities with 926,591 tests)
> 3. **Which age group?** → Under-5 children (the highest risk group)
>
> But notice - I didn't just follow prompts robotically. During the workflow, I asked: **'Why do you recommend primary health facilities?'**
>
> [SCROLL UP to show question if visible]
>
> And ChatMRPT gave me an intelligent answer explaining that primary facilities are the first point of contact for communities, especially in rural areas, and provide robust data for statistical analysis. This is conversational intelligence - not just a form.
>
> [SCROLL TO RESULTS]
>
...
✅ Data prepared for risk analysis
```

**Transition:**
> "So now we have TPR calculated. But before running risk analysis, let me show you something powerful...
>
> [TYPE: 'Tell me about the variables in my data']
>
> Watch how ChatMRPT explains each variable - not just listing them, but explaining WHY they matter for malaria:
>
> [SHOW RESPONSE]
>
> - TPR: Test Positivity Rate - the percentage of tested individuals who were positive
> - distance_to_waterbodies: Distance to nearest water bodies - affects mosquito breeding
> - rainfall: Amount of rainfall - affects mosquito habitat and transmission
> - soil_wetness: Soil moisture level - related to breeding conditions
> - urban_percentage: Urbanization level - influences housing quality and drainage
>
> This is educational. It's not just processing data - it's teaching you about the epidemiology. Now let's run the risk analysis..."
...
✅ unified_dataset.csv (226 wards with rankings)
✅ Shapefile with risk scores

Download available below ⬇️
```
...
**Transition:**
> "So that's the core workflow: TPR → Risk → ITN. But ChatMRPT also has unique features for learning and knowledge assessment. Let me quickly show you the Arena..."
...
>
> 1. ✅ **TPR analysis** - Calculate test positivity rates by facility, age group, and location
> 2. ✅ **Risk analysis** - Create vulnerability maps ranking wards from highest to lowest risk
> 3. ✅ **ITN planning** - Optimize bed net distribution based on risk and population
> 4. ✅ **Arena** - Learn malaria concepts through interactive AI comparisons
> 5. ✅ **AI Agent** - Ask your data questions in plain English
>
...
### Energy & Pacing:
- ⚡ **Start FAST** - capture attention immediately
- 🎯 **Focus on OUTPUTS** not process
- 🚀 **Show SPEED** - emphasize "minutes not hours"
- 🎬 **Use pre-loaded tabs** - don't waste time waiting
- ⏱️ **Watch the clock** - stick to timing strictly

### What to Emphasize:
- ✅ **SPEED** - minutes not hours, no coding required
- ✅ **ACTIONABLE** - ranked lists, allocation plans, maps
- ✅ **COMPREHENSIVE** - full workflow (TPR → Risk → ITN)
- ✅ **REALISTIC** - acknowledge data cleaning, show real use cases

### What NOT to Do:
- ❌ Don't explain algorithms (PCA, composite scoring math)
- ❌ Don't show errors or bugs (use pre-loaded tabs!)
- ❌ Don't let Q&A derail flow (save for breakout)
- ❌ Don't make it academic/boring (keep energy high)
- ❌ Don't run over time (cut Tab 6 if needed)

### Backup Plans:
- **If upload fails** → Immediately switch to pre-loaded Tab 2
- **If tab doesn't load** → Show screenshot OR skip it
- **If Arena broken** → Use backup script OR show screenshot
- **If running over** → Cut Tab 6 (AI Agent)
- **If internet fails** → Have screenshots ready as fallback
...
- ✅ Participants are EXCITED (not bored/confused)
- ✅ They ask good questions during breakout
- ✅ They can articulate what ChatMRPT does (TPR → Risk → ITN)
- ✅ They see themselves using it in their work
- ✅ They want access to the tool

**Red flags to watch for:**
- ⚠️ Participants look confused or lost
- ⚠️ Too many technical questions (means you got too detailed)
- ⚠️ People on phones/distracted (means you're boring)
- ⚠️ Questions like "how does PCA work?" (too academic)

**If you see red flags:**
- 🔧 Speed up, show more outputs
- 🔧 Simplify language, drop jargon
- 🔧 Show excitement yourself (it's contagious!)

---

**Status:** Ready for practice run
**Next Step:** Practice the demo with timer, refine pacing
**Goal:** Get participants FIRED UP to use ChatMRPT! 🔥
